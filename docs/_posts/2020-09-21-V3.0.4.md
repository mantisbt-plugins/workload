	...
	<body>
		...
		<div id="main_content_wrap" class="outer">
			<section id="main_content" class="inner">
				...
				<div>
					<h2>Content</h2>
					<a href="https://github.com/mantisbt-plugins/workload/issues/13">Verify latest pull requests and clean warnings</a>					
					<a href="https://github.com/mantisbt-plugins/workload/pull/11">Use single quotes for lang strings</a>
					<a href="https://github.com/mantisbt-plugins/workload/pull/10">Add print_bracket_link function removed from MantisBT 2.11</a>
